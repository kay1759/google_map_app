...
export const getAjax = (url: string, params: TAssociative, options: TAssociative = {}) => {
    return ajax.getAjax(url, params, processOK, processErr, options);
};

export const postAjax = (url: string, params: TAssociative, options: TAssociative = {}) => {
    return ajax.postAjax(url, params, processOK, processErr, options);
};

export const putAjax = (url: string, params: TAssociative, options: TAssociative = {}) => {
    return ajax.putAjax(url, params, processOK, processErr, options);
};

export const patchAjax = (url: string, params: TAssociative, options: TAssociative = {}) => {
    return ajax.patchAjax(url, params, processOK, processErr, options);
};

export const deleteAjax = (url: string, params: TAssociative, options: TAssociative = {}) => {
